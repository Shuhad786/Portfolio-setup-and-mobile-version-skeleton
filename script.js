...
const PopupArray = [{
  ...
  imgDiv: './images/Rectangle%2070.png',
...
for (let i = 0; i < PopupArray.length; i += 1) {
  ...
  image.innerHTML = PopupArray[i].img;
